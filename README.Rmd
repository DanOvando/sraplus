...
If your version of R is lower than 3.5, you might want to consider updating R itself. Updating from 3.3 to 3.5 shouldn't be any hastle. BIG WARNING THOUGH, updating from say R 2.9 to 3.5 is a major update, and you'll lose all your installed packages in the process. I recommend following the instructions [here](https://www.datascienceriot.com/r/upgrade-R-packages/) to deal with that, but even with that fix it can take a while, so I don't recommend doing a major R update if you're on a deadline.
