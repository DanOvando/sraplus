...
This package uses the [`TMBtools`](https://github.com/mlysy/TMBtools). If you make modifications to the core model in `src/TMB/sraplus_tmb.hpp`, you need to run `TMBtools::export_models()` prior to building the package. 
