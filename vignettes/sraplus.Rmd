...
As a final step, we can try adding in some fictional SAR data to our fake fishery, just to see how it works. 


```{r, results = "hide"}
cpue_sar_driors <- format_driors(taxa = example_taxa,
                           catch = sim$pop$catch,
                           years = sim$pop$year,
                           effort = sim$pop$effort,
                           effort_years = sim$pop$year,
...
cpue_sar_fit <- fit_sraplus(driors = cpue_sar_driors,
                             engine = "stan",
                             model = "sraplus_tmb",
                             adapt_delta = 0.9,
                             max_treedepth = 10,
