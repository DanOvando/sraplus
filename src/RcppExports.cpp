...
// sraplus
List sraplus(NumericVector catches, NumericVector rs, NumericVector ms, NumericVector init_deps, NumericVector ks, NumericVector qs, NumericVector sigma_procs, NumericVector drawdex, NumericVector index_t, NumericVector sigma_obs, NumericVector log_final_u, NumericVector log_final_u_cv, IntegerVector index_years, IntegerVector u_years, int draws, int n_keep, int b_ref_type, int f_ref_type, int fit_index, int use_final_u, int use_final_state, double log_final_ref, double sigma_dep, double plim, int use_u_prior, NumericVector u_priors, double sigma_u);
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(sraplus(catches, rs, ms, init_deps, ks, qs, sigma_procs, drawdex, index_t, sigma_obs, log_final_u, log_final_u_cv, index_years, u_years, draws, n_keep, b_ref_type, f_ref_type, fit_index, use_final_u, use_final_state, log_final_ref, sigma_dep, plim, use_u_prior, u_priors, sigma_u));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_sraplus_sraplus", (DL_FUNC) &_sraplus_sraplus, 27},
    {NULL, NULL, 0}
};
